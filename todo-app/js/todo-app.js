...
function createAppTitle(title) {
  ...
  appTitle.classList.add('title-local')
...
function createTodoItemForm() {
  ...
  form.classList.add('input-group', 'mb-3', 'form-local');
...
function createTodoList() {
  ...
  list.classList.add('list-group', 'mb-5', 'list-local');
  return list;
}
...
function createTodoAppLocal(container, title = 'Список дел', keyName) {
